...
class Utils:
        ...
        if test_concurrency:
            ...
            try:
                ...
                if results.sequential_throughput:
                    improvement = ((results.concurrent_throughput - results.sequential_throughput) 
                                  / results.sequential_throughput * 100)
                    if improvement > 10:
    ...
    def _test_connection_pool_validation(self) -> tuple[bool, list[str]]:
        ...
        try:
            ...
            try:
                _ = FortiOS('test.example.com', token='test', 
            ...
            try:
                _ = FortiOS('test.example.com', token='test', 
                           max_connections=5, max_keepalive_connections=20)
