"""
FortiOS MONITOR - Monitor Utm Antivirus

Monitoring endpoint for monitor utm antivirus data.

API Endpoints:
    GET    /monitor/utm/antivirus
...
Example Usage:
    ...
    >>> data = fgt.api.monitor.utm.antivirus.get()
    >>>
