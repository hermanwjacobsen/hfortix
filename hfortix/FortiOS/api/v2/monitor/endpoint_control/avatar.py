"""
FortiOS MONITOR - Monitor Endpoint Control Avatar

Monitoring endpoint for monitor endpoint control avatar data.

API Endpoints:
    GET    /monitor/endpoint_control/avatar
...
Example Usage:
    ...
    >>> data = fgt.api.monitor.endpoint_control.avatar.get()
    >>> 
