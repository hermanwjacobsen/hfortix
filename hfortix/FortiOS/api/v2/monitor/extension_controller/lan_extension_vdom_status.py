...
Monitoring endpoint for monitor extension controller lan extension vdom status data.
...
Example Usage:
    ...
    >>> data = fgt.api.monitor.extension_controller.lan_extension_vdom_status.get()
    >>>
