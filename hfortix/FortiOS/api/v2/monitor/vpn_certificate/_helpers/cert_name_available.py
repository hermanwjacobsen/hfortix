"""
Validation helpers for vpn_certificate cert_name_available endpoint.
...
def validate_cert_name_available_get(
    mkey: str | None = None,
    attr: str | None = None,
    ...
    **params: Any,
    ...
    Example:
        ...
        >>>
        >>> # Get specific object
        >>> is_valid, error = validate_cert_name_available_get(mkey="value")
        >>> if not is_valid:
