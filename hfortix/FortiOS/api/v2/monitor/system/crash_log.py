"""
FortiOS MONITOR - Monitor System Crash Log

Monitoring endpoint for monitor system crash log data.

API Endpoints:
    GET    /monitor/system/crash_log
...
Example Usage:
    ...
    >>> data = fgt.api.monitor.system.crash_log.get()
    >>> 
