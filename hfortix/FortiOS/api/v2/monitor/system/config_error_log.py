"""
FortiOS MONITOR - Monitor System Config Error Log

Monitoring endpoint for monitor system config error log data.

API Endpoints:
    GET    /monitor/system/config_error_log
...
Example Usage:
    ...
    >>> data = fgt.api.monitor.system.config_error_log.get()
    >>>
