"""
FortiOS MONITOR - Monitor System Cluster

Monitoring endpoint for monitor system cluster data.

API Endpoints:
    GET    /monitor/system/cluster
...
Example Usage:
    ...
    >>> data = fgt.api.monitor.system.cluster.get()
    >>> 
