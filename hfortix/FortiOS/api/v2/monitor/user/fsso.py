"""
FortiOS MONITOR - Monitor User Fsso

Monitoring endpoint for monitor user fsso data.
...
Example Usage:
    ...
    >>> data = fgt.api.monitor.user.fsso.get()
    >>> 
...
class RefreshServer:
    ...
    Provides read-only access for FortiOS refreshserver data.
