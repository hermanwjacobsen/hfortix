"""
Validation helpers for fortiview realtime_statistics endpoint.
...
def validate_realtime_statistics_get(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>>
        >>> # Get specific object
        >>> is_valid, error = validate_realtime_statistics_get(policyid="value")
        >>> if not is_valid:
...
def validate_realtime_statistics_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating realtime_statistics.
