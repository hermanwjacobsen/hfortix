"""
FortiOS MONITOR - Monitor Log Forticloud

Monitoring endpoint for monitor log forticloud data.
...
Example Usage:
    ...
    >>> data = fgt.api.monitor.log.forticloud.get()
    >>>
...
class Connection:
    ...
    Provides read-only access for FortiOS connection data.
