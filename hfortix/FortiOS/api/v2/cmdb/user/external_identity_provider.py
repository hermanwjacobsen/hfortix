"""
FortiOS CMDB - User ExternalIdentityProvider

API Endpoints:
    GET    /user/external-identity-provider
    POST   /user/external-identity-provider
    GET    /user/external-identity-provider/{name}
    PUT    /user/external-identity-provider/{name}
    DELETE /user/external-identity-provider/{name}
"""
