    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            secondary_server: Secondary LDAP server CN domain name or IP. (optional)
            tertiary_server: Tertiary LDAP server CN domain name or IP. (optional)
            ...
            server_identity_check: Enable/disable LDAP server identity check (verify server domain name/IP address against the server certificate). (optional)
            source_ip: FortiGate IP address to be used for communication with the LDAP server. (optional)
            source_ip_interface: Source interface for communication with the LDAP server. (optional)
            source_port: Source port to be used for communication with the LDAP server. (optional)
            cnid: Common name identifier for the LDAP server. The common name identifier for most LDAP servers is "cn". (optional)
            dn: Distinguished name used to look up entries on the LDAP server. (optional)
            ...
            two_factor_filter: Filter used to synchronize users to FortiToken Cloud. (optional)
            ...
            port: Port to be used for communication with the LDAP server (default = 389). (optional)
            password_expiry_warning: Enable/disable password expiry warnings. (optional)
            password_renewal: Enable/disable online password renewal. (optional)
            member_attr: Name of attribute from which to get group membership. (optional)
            ...
            account_key_filter: Account key filter, using the UPN as the search filter. (optional)
            search_type: Search type. (optional)
            client_cert_auth: Enable/disable using client certificate for TLS authentication. (optional)
            client_cert: Client certificate name. (optional)
            obtain_user_info: Enable/disable obtaining of user information. (optional)
            user_info_exchange_server: MS Exchange server from which to fetch user information. (optional)
            ...
            antiphish: Enable/disable AntiPhishing credential backend. (optional)
