"""
Validation helpers for videofilter profile endpoint.
...
VALID_BODY_YOUTUBE = ["enable", "disable"]
VALID_BODY_VIMEO = ["enable", "disable"]
VALID_BODY_DAILYMOTION = ["enable", "disable"]
