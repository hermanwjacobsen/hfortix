"""
FortiOS CMDB - Ztna WebProxy

API Endpoints:
    GET    /ztna/web-proxy
    POST   /ztna/web-proxy
    GET    /ztna/web-proxy/{name}
    PUT    /ztna/web-proxy/{name}
    DELETE /ztna/web-proxy/{name}
"""
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            svr_pool_multiplex: Enable/disable server pool multiplexing (default = disable). Share connected server in HTTP and HTTPS api-gateways. (optional)
            svr_pool_ttl: Time-to-live in the server pool for idle connections to servers. (optional)
            svr_pool_server_max_request: Maximum number of requests that servers in the server pool handle before disconnecting (default = unlimited). (optional)
            svr_pool_server_max_concurrent_request: Maximum number of concurrent requests that servers in the server pool could handle (default = unlimited). (optional)
