"""
FortiOS CMDB - Web-proxy Profile

API Endpoints:
    GET    /web-proxy/profile
    POST   /web-proxy/profile
    GET    /web-proxy/profile/{name}
    PUT    /web-proxy/profile/{name}
    DELETE /web-proxy/profile/{name}
"""
