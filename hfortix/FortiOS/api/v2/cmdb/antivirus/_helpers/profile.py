        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 193:
                    return (
                        False,
                        f"fortisandbox-max-upload must be between 1 and 193",
                    )
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 4294967295:
                    return (
                        False,
                        f"analytics-ignore-filetype must be between 0 and 4294967295",
                    )
            except (ValueError, TypeError):
                return (
                    False,
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 4294967295:
                    return (
                        False,
                        f"analytics-accept-filetype must be between 0 and 4294967295",
                    )
            except (ValueError, TypeError):
                return (
                    False,
