...
Configuration endpoint for managing cmdb wireless controller hotspot20 h2qp wan metric objects.
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.wireless_controller.hotspot20_h2qp_wan_metric.get(name="item_name")
    >>> 
    ...
    >>> 
    >>> # Delete item
    >>> result = fgt.api.cmdb.wireless_controller.hotspot20_h2qp_wan_metric.delete(name="item_name")
