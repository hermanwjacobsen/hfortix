"""
FortiOS CMDB - Wireless-controller Wtp

API Endpoints:
    GET    /wireless-controller/wtp
    POST   /wireless-controller/wtp
    GET    /wireless-controller/wtp/{wtp-id}
    PUT    /wireless-controller/wtp/{wtp-id}
    DELETE /wireless-controller/wtp/{wtp-id}
"""
