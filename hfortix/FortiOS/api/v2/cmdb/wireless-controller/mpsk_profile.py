...
Configuration endpoint for managing cmdb wireless controller mpsk profile objects.
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.wireless_controller.mpsk_profile.get(name="item_name")
    >>>
    ...
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.wireless_controller.mpsk_profile.delete(name="item_name")
