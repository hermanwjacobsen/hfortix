...
Configuration endpoint for managing cmdb wireless controller lw profile objects.
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.wireless_controller.lw_profile.get(name="item_name")
    >>>
    ...
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.wireless_controller.lw_profile.delete(name="item_name")
