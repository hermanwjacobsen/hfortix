"""
FortiOS CMDB - Wireless-controller ApcfgProfile

API Endpoints:
    GET    /wireless-controller/apcfg-profile
    POST   /wireless-controller/apcfg-profile
    GET    /wireless-controller/apcfg-profile/{name}
    PUT    /wireless-controller/apcfg-profile/{name}
    DELETE /wireless-controller/apcfg-profile/{name}
"""
...
class ApcfgProfile:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        # Build endpoint path
        if name:
            endpoint = f"/wireless-controller/apcfg-profile/{name}"
        else:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        if ap_family is not None:
            data_payload['ap-family'] = ap_family
        if comment is not None:
            data_payload['comment'] = comment
        if ac_type is not None:
            data_payload['ac-type'] = ac_type
        if ac_timer is not None:
            data_payload['ac-timer'] = ac_timer
        if ac_ip is not None:
            data_payload['ac-ip'] = ac_ip
        if ac_port is not None:
            data_payload['ac-port'] = ac_port
        if command_list is not None:
            data_payload['command-list'] = command_list
