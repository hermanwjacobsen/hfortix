"""
FortiOS CMDB - Wireless-controller BleProfile

API Endpoints:
    GET    /wireless-controller/ble-profile
    POST   /wireless-controller/ble-profile
    GET    /wireless-controller/ble-profile/{name}
    PUT    /wireless-controller/ble-profile/{name}
    DELETE /wireless-controller/ble-profile/{name}
"""
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            ibeacon_uuid: Universally Unique Identifier (UUID; automatically assigned but can be manually reset). (optional)
            ...
            ble_scanning: Enable/disable Bluetooth Low Energy (BLE) scanning. (optional)
            scan_type: Scan Type (default = active). (optional)
            scan_threshold: Minimum signal level/threshold in dBm required for the AP to report detected BLE device (-95 to -20, default = -90). (optional)
