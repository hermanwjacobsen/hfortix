"""
FortiOS CMDB - Switch-controller Eight02OneXSettings

API Endpoints:
    GET    /switch-controller/802-1X-settings
    PUT    /switch-controller/802-1X-settings
"""
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            link_down_auth: Interface-reauthentication state to set if a link is down. (optional)
            reauth_period: Period of time to allow for reauthentication (1 - 1440 sec, default = 60, 0 = disable reauthentication). (optional)
            max_reauth_attempt: Maximum number of authentication attempts (0 - 15, default = 3). (optional)
