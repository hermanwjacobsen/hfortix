"""
Validation helpers for switch-controller acl_ingress endpoint.
...
def validate_acl_ingress_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating acl_ingress.
...
def validate_acl_ingress_delete(
    id: str | None = None,
) -> tuple[bool, str | None]:
    """
