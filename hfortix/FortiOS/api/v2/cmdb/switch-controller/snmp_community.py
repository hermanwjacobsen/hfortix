...
Configuration endpoint for managing cmdb switch controller snmp community objects.
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.switch_controller.snmp_community.get(name="item_name")
    >>>
    ...
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.switch_controller.snmp_community.delete(name="item_name")
