"""
FortiOS CMDB - Cmdb Switch Controller Snmp Sysinfo

Configuration endpoint for managing cmdb switch controller snmp sysinfo objects.

API Endpoints:
    GET    /cmdb/switch-controller/snmp_sysinfo
    PUT    /cmdb/switch-controller/snmp_sysinfo/{identifier}
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.switch_controller.snmp_sysinfo.get(name="item_name")
    >>>
    >>> # Create new item (use POST)
    >>> result = fgt.api.cmdb.switch_controller.snmp_sysinfo.post(
    ...     name="new_item",
    ...
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.switch_controller.snmp_sysinfo.delete(name="item_name")
