...
Configuration endpoint for managing cmdb switch controller stp settings objects.
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.switch_controller.stp_settings.get(name="item_name")
    >>>
    ...
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.switch_controller.stp_settings.delete(name="item_name")
