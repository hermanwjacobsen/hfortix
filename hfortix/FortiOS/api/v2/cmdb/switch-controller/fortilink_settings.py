...
Configuration endpoint for managing cmdb switch controller fortilink settings objects.
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.switch_controller.fortilink_settings.get(name="item_name")
    >>> 
    ...
    >>> 
    >>> # Delete item
    >>> result = fgt.api.cmdb.switch_controller.fortilink_settings.delete(name="item_name")
