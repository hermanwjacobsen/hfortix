"""
FortiOS CMDB - Cmdb Switch Controller Igmp Snooping

Configuration endpoint for managing cmdb switch controller igmp snooping objects.

API Endpoints:
    GET    /cmdb/switch-controller/igmp_snooping
    PUT    /cmdb/switch-controller/igmp_snooping/{identifier}
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.switch_controller.igmp_snooping.get(name="item_name")
    >>>
    >>> # Create new item (use POST)
    >>> result = fgt.api.cmdb.switch_controller.igmp_snooping.post(
    ...     name="new_item",
    ...
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.switch_controller.igmp_snooping.delete(name="item_name")
...
class IgmpSnooping:
    ...
    Provides CRUD operations for FortiOS igmpsnooping configuration.
