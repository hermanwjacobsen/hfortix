"""
FortiOS CMDB - Cmdb Log Tacacs Plus Accounting2 Setting

Configuration endpoint for managing cmdb log tacacs plus accounting2 setting objects.

API Endpoints:
    GET    /cmdb/log/tacacs_plus_accounting2_setting
    PUT    /cmdb/log/tacacs_plus_accounting2_setting/{identifier}
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.log.tacacs_plus_accounting2_setting.get(name="item_name")
    >>> 
    >>> # Create new item (use POST)
    >>> result = fgt.api.cmdb.log.tacacs_plus_accounting2_setting.post(
    ...     name="new_item",
    ...
    >>> 
    >>> # Delete item
    >>> result = fgt.api.cmdb.log.tacacs_plus_accounting2_setting.delete(name="item_name")
...
class TacacsPlusAccounting2Setting:
    ...
    Provides CRUD operations for FortiOS tacacsplusaccounting2setting configuration.
