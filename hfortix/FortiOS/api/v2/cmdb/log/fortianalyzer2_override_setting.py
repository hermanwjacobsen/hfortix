"""
FortiOS CMDB - Log Fortianalyzer2OverrideSetting

API Endpoints:
    GET    /log.fortianalyzer2/override-setting
    PUT    /log.fortianalyzer2/override-setting
"""
...
class Fortianalyzer2OverrideSetting:
    ...
    def __init__(self, client: 'HTTPClient'):
        """
        Initialize Fortianalyzer2OverrideSetting endpoint.
