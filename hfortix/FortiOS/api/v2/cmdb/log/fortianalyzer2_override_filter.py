"""
FortiOS CMDB - Cmdb Log Fortianalyzer2 Override Filter

Configuration endpoint for managing cmdb log fortianalyzer2 override filter objects.

API Endpoints:
    GET    /cmdb/log/fortianalyzer2_override_filter
    PUT    /cmdb/log/fortianalyzer2_override_filter/{identifier}
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.cmdb.log.fortianalyzer2_override_filter.get()
    >>>
    >>> # Get specific item (if supported)
    >>> item = fgt.api.cmdb.log.fortianalyzer2_override_filter.get(name="item_name")
    >>>
    >>> # Create new item (use POST)
    >>> result = fgt.api.cmdb.log.fortianalyzer2_override_filter.post(
    ...     name="new_item",
    ...     # ... additional parameters
    ... )
    >>>
    >>> # Update existing item (use PUT)
    >>> result = fgt.api.cmdb.log.fortianalyzer2_override_filter.put(
    ...     name="existing_item",
    ...     # ... parameters to update
    ... )
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.log.fortianalyzer2_override_filter.delete(name="item_name")
...
class Fortianalyzer2OverrideFilter:
    ...
    Provides CRUD operations for FortiOS fortianalyzer2overridefilter configuration.
