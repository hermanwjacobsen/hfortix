"""
Validation helpers for log fortianalyzer2_override_filter endpoint.
...
def validate_fortianalyzer2_override_filter_get(
    attr: str | None = None,
...
def validate_fortianalyzer2_override_filter_put(
