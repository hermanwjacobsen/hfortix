"""
Validation helpers for log custom_field endpoint.
...
def validate_custom_field_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating custom_field.
...
def validate_custom_field_delete(
    id: str | None = None,
) -> tuple[bool, str | None]:
    """
