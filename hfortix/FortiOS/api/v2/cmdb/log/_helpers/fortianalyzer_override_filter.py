"""
Validation helpers for log fortianalyzer_override_filter endpoint.
...
def validate_fortianalyzer_override_filter_get(
    attr: str | None = None,
...
def validate_fortianalyzer_override_filter_put(
