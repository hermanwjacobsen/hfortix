"""
Validation helpers for log fortianalyzer_cloud_setting endpoint.
...
def validate_fortianalyzer_cloud_setting_get(
    attr: str | None = None,
...
def validate_fortianalyzer_cloud_setting_put(
