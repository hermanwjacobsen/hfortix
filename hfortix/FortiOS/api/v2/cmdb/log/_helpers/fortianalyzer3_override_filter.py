"""
Validation helpers for log fortianalyzer3_override_filter endpoint.
...
VALID_BODY_DLP_ARCHIVE = ["enable", "disable"]
...
def validate_fortianalyzer3_override_filter_get(
    attr: str | None = None,
...
def validate_fortianalyzer3_override_filter_put(
