"""
Validation helpers for log fortianalyzer2_override_setting endpoint.
...
def validate_fortianalyzer2_override_setting_get(
    attr: str | None = None,
...
def validate_fortianalyzer2_override_setting_put(
