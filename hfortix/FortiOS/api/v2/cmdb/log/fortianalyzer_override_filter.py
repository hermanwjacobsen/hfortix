"""
FortiOS CMDB - Cmdb Log Fortianalyzer Override Filter

Configuration endpoint for managing cmdb log fortianalyzer override filter objects.

API Endpoints:
    GET    /cmdb/log/fortianalyzer_override_filter
    PUT    /cmdb/log/fortianalyzer_override_filter/{identifier}
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.log.fortianalyzer_override_filter.get(name="item_name")
    >>> 
    >>> # Create new item (use POST)
    >>> result = fgt.api.cmdb.log.fortianalyzer_override_filter.post(
    ...     name="new_item",
    ...
    >>> 
    >>> # Delete item
    >>> result = fgt.api.cmdb.log.fortianalyzer_override_filter.delete(name="item_name")
...
class FortianalyzerOverrideFilter:
    """
    Fortianalyzeroverridefilter Operations.
    
    Provides CRUD operations for FortiOS fortianalyzeroverridefilter configuration.
    ...
    def __init__(self, client: 'HTTPClient'):
        """
        Initialize FortianalyzerOverrideFilter endpoint.
