...
Configuration endpoint for managing cmdb log fortianalyzer3 override setting objects.
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.log.fortianalyzer3_override_setting.get(name="item_name")
    >>>
    ...
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.log.fortianalyzer3_override_setting.delete(name="item_name")
...
class Fortianalyzer3OverrideSetting:
    ...
    Provides CRUD operations for FortiOS fortianalyzer3overridesetting configuration.
