"""
FortiOS CMDB - Cmdb Log Fortianalyzer Cloud Setting

Configuration endpoint for managing cmdb log fortianalyzer cloud setting objects.

API Endpoints:
    GET    /cmdb/log/fortianalyzer_cloud_setting
    PUT    /cmdb/log/fortianalyzer_cloud_setting/{identifier}
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.log.fortianalyzer_cloud_setting.get(name="item_name")
    >>>
    >>> # Create new item (use POST)
    >>> result = fgt.api.cmdb.log.fortianalyzer_cloud_setting.post(
    ...     name="new_item",
    ...
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.log.fortianalyzer_cloud_setting.delete(name="item_name")
...
class FortianalyzerCloudSetting:
    """
    Fortianalyzercloudsetting Operations.

    Provides CRUD operations for FortiOS fortianalyzercloudsetting configuration.
    ...
    def __init__(self, client: "IHTTPClient"):
        """
        Initialize FortianalyzerCloudSetting endpoint.
