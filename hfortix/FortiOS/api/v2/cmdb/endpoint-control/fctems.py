"""
FortiOS CMDB - Endpoint-control Fctems

API Endpoints:
    GET    /endpoint-control/fctems
    POST   /endpoint-control/fctems
    GET    /endpoint-control/fctems/{ems-id}
    PUT    /endpoint-control/fctems/{ems-id}
    DELETE /endpoint-control/fctems/{ems-id}
"""
