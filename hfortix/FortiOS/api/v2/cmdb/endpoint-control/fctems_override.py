"""
FortiOS CMDB - Endpoint-control FctemsOverride

API Endpoints:
    GET    /endpoint-control/fctems-override
    POST   /endpoint-control/fctems-override
    GET    /endpoint-control/fctems-override/{ems-id}
    PUT    /endpoint-control/fctems-override/{ems-id}
    DELETE /endpoint-control/fctems-override/{ems-id}
"""
