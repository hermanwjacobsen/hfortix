...
Example Usage:
    ...
    >>> # Delete item
    >>> result =
    fgt.api.cmdb.firewall.schedule_recurring.delete(name="item_name")
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            label_day: Configure a window during the time of day in which the
            schedule job is executed. (optional)
