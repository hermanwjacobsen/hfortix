    ...
    def create(
        ...
        **kwargs
        ...
        if block_blocklisted_certificates is not None:
            data['block-blocklisted-certificates'] = block_blocklisted_certificates
        ...
        if ech_outer_sni is not None:
            data['ech-outer-sni'] = ech_outer_sni
        if ftps is not None:
            data['ftps'] = ftps
        ...
        if ssl_anomaly_log is not None:
            data['ssl-anomaly-log'] = ssl_anomaly_log
        if ssl_exempt is not None:
            data['ssl-exempt'] = ssl_exempt
        if ssl_exemption_ip_rating is not None:
            data['ssl-exemption-ip-rating'] = ssl_exemption_ip_rating
        if ssl_exemption_log is not None:
            data['ssl-exemption-log'] = ssl_exemption_log
        if ssl_handshake_log is not None:
            data['ssl-handshake-log'] = ssl_handshake_log
        if ssl_negotiation_log is not None:
            data['ssl-negotiation-log'] = ssl_negotiation_log
        if ssl_server is not None:
            data['ssl-server'] = ssl_server
        if ssl_server_cert_log is not None:
            data['ssl-server-cert-log'] = ssl_server_cert_log
        if supported_alpn is not None:
            data['supported-alpn'] = supported_alpn
        if untrusted_caname is not None:
            data['untrusted-caname'] = untrusted_caname
        if use_ssl_server is not None:
            data['use-ssl-server'] = use_ssl_server
