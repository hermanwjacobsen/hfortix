"""
Validation helpers for firewall DoS_policy endpoint.
...
def validate_DoS_policy_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating DoS_policy.
...
def validate_DoS_policy_delete(
