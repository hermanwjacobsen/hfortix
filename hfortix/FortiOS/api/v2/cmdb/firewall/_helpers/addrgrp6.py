"""
Validation helpers for firewall addrgrp6 endpoint.
...
def validate_addrgrp6_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating addrgrp6.
