"""
Validation helpers for firewall vipgrp6 endpoint.
...
def validate_vipgrp6_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating vipgrp6.
