    ...
    def create(
        ...
        **kwargs
        ...
        if case_sensitivity is not None:
            data['case-sensitivity'] = case_sensitivity
        ...
        if header_group is not None:
            data['header-group'] = header_group
        if header_name is not None:
            data['header-name'] = header_name
        if host is not None:
            data['host'] = host
        if host_regex is not None:
            data['host-regex'] = host_regex
        ...
        if ua_max_ver is not None:
            data['ua-max-ver'] = ua_max_ver
        if ua_min_ver is not None:
            data['ua-min-ver'] = ua_min_ver
        if uuid is not None:
            data['uuid'] = uuid
