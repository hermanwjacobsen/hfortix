"""
FortiOS CMDB - Firewall AccessProxy

API Endpoints:
    GET    /firewall/access-proxy
    POST   /firewall/access-proxy
    GET    /firewall/access-proxy/{name}
    PUT    /firewall/access-proxy/{name}
    DELETE /firewall/access-proxy/{name}
"""
