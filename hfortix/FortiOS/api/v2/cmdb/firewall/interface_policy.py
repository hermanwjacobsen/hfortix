"""
FortiOS CMDB - Cmdb Firewall Interface Policy

Configuration endpoint for managing cmdb firewall interface policy objects.
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.firewall.interface_policy.get(name="item_name")
    >>> 
    ...
    >>> 
    >>> # Delete item
    >>> result = fgt.api.cmdb.firewall.interface_policy.delete(name="item_name")
...
class InterfacePolicy:
    ...
    Provides CRUD operations for FortiOS interfacepolicy configuration.
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            srcaddr: Address object to limit traffic monitoring to network traffic sent from the specified address or range. (optional)
            dstaddr: Address object to limit traffic monitoring to network traffic sent to the specified address or range. (optional)
