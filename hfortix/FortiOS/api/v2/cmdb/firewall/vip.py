    ...
    def create(
        ...
        **kwargs
        ...
        if add_nat46_route is not None:
            data['add-nat46-route'] = add_nat46_route
        if arp_reply is not None:
            data['arp-reply'] = arp_reply
        ...
        if dns_mapping_ttl is not None:
            data['dns-mapping-ttl'] = dns_mapping_ttl
        ...
        if gratuitous_arp_interval is not None:
            data['gratuitous-arp-interval'] = gratuitous_arp_interval
        if gslb_domain_name is not None:
            data['gslb-domain-name'] = gslb_domain_name
        if gslb_hostname is not None:
            data['gslb-hostname'] = gslb_hostname
        if gslb_public_ips is not None:
            data['gslb-public-ips'] = gslb_public_ips
        ...
        if http_multiplex_max_concurrent_request is not None:
            data['http-multiplex-max-concurrent-request'] = http_multiplex_max_concurrent_request
        if http_multiplex_max_request is not None:
            data['http-multiplex-max-request'] = http_multiplex_max_request
        if http_multiplex_ttl is not None:
            data['http-multiplex-ttl'] = http_multiplex_ttl
        ...
        if one_click_gslb_server is not None:
            data['one-click-gslb-server'] = one_click_gslb_server
        ...
        if portmapping_type is not None:
            data['portmapping-type'] = portmapping_type
        ...
        if srcintf_filter is not None:
            data['srcintf-filter'] = srcintf_filter
