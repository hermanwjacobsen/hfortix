"""
FortiOS CMDB - Firewall ServiceCustom
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            tcp_halfclose_timer: Wait time to close a TCP session waiting for an unanswered FIN packet (1 - 86400 sec, 0 = default). (optional)
            tcp_halfopen_timer: Wait time to close a TCP session waiting for an unanswered open session packet (1 - 86400 sec, 0 = default). (optional)
            tcp_timewait_timer: Set the length of the TCP TIME-WAIT state in seconds (1 - 300 sec, 0 = default). (optional)
            tcp_rst_timer: Set the length of the TCP CLOSE state in seconds (5 - 300 sec, 0 = default). (optional)
            udp_idle_timer: Number of seconds before an idle UDP/UDP-Lite connection times out (0 - 86400 sec, 0 = default). (optional)
