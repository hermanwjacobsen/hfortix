"""
FortiOS CMDB - Cmdb Firewall Decrypted Traffic Mirror

Configuration endpoint for managing cmdb firewall decrypted traffic mirror objects.
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.firewall.decrypted_traffic_mirror.get(name="item_name")
    >>>
    >>> # Create new item (use POST)
    >>> result = fgt.api.cmdb.firewall.decrypted_traffic_mirror.post(
    ...     name="new_item",
    ...
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.firewall.decrypted_traffic_mirror.delete(name="item_name")
...
class DecryptedTrafficMirror:
    ...
    Provides CRUD operations for FortiOS decryptedtrafficmirror configuration.
