    ...
    def create(
        ...
        **kwargs
        ...
        if dns_match_ip is not None:
            data['dns-match-ip'] = dns_match_ip
        if dns_protocol is not None:
            data['dns-protocol'] = dns_protocol
        if dns_request_domain is not None:
            data['dns-request-domain'] = dns_request_domain
        if http_get is not None:
            data['http-get'] = http_get
        if http_match is not None:
            data['http-match'] = http_match
        if http_max_redirects is not None:
            data['http-max-redirects'] = http_max_redirects
