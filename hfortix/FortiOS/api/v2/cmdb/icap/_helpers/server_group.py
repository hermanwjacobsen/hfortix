"""
Validation helpers for icap server_group endpoint.
...
def validate_server_group_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating server_group.
...
def validate_server_group_delete(
    name: str | None = None,
) -> tuple[bool, str | None]:
    """
