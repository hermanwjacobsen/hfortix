...
def validate_static6_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating static6.
...
def validate_static6_delete() -> tuple[bool, str | None]:
    """
