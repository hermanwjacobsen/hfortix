"""
Validation helpers for router policy endpoint.
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 65535:
                    return (
                        False,
                        f"start-source-port must be between 0 and 65535",
                    )
            except (ValueError, TypeError):
                return (
                    False,
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 65535:
                    return (
                        False,
                        f"end-source-port must be between 0 and 65535",
                    )
            except (ValueError, TypeError):
                return (
                    False,
...
def validate_policy_delete() -> tuple[bool, str | None]:
    """
