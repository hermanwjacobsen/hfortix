"""
Validation helpers for router rip endpoint.
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 2147483647:
                    return (
                        False,
                        f"update-timer must be between 1 and 2147483647",
                    )
            except (ValueError, TypeError):
