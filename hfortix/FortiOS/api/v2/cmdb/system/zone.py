    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            intrazone: Allow or deny traffic routing between different interfaces in the same zone (default = deny). (optional)
            interface: Add interfaces to this zone. Interfaces must not be assigned to another zone or have firewall policies defined. (optional)
            vdom: Virtual domain name, or False to skip. Handled by HTTPClient.
            raw_json: If True, return full API response with metadata. If False, return only results.
            **kwargs: Additional query parameters (filter, sort, start, count, format, etc.)
        ...
        if intrazone is not None:
            data_payload["intrazone"] = intrazone
