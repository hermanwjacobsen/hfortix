...
class Zone:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.zone.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.zone.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", f"system/zone/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.zone.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/zone/{encode_path_component(name)}", vdom=vdom)
    ...
    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        ...
        Examples:
            >>> if fgt.api.cmdb.system.zone.exists('obj1'):
            ...     print("Exists")
        """
        try:
