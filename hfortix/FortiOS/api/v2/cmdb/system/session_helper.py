"""
FortiOS CMDB - System SessionHelper
...
class SessionHelper:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.session_helper.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.session_helper.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", f"system/session-helper/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.session_helper.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/session-helper/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if session-helper exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.session_helper.exists('obj1'):
            ...     print("Exists")
        """
        try:
