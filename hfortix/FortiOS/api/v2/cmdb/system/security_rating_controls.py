...
class SecurityRatingControls:
    """security-rating controls endpoint"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.security_rating_controls.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.security_rating_controls.get(name='obj1')
        """
        params = {}
        ...
        path = "system.security-rating/controls"
        if name:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update security-rating controls
        ...
        return self._client.put("cmdb", f"system.security-rating/controls/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        """
        Delete security-rating controls
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.security_rating_controls.delete('obj1')
        """
        return self._client.delete("cmdb", f"system.security-rating/controls/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if security-rating controls exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.security_rating_controls.exists('obj1'):
            ...     print("Exists")
        """
        try:
