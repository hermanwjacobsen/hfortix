"""
FortiOS CMDB - System SsoFortigateCloudAdmin
...
class SsoFortigateCloudAdmin:
    """sso-fortigate-cloud-admin endpoint"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.sso_fortigate_cloud_admin.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.sso_fortigate_cloud_admin.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update sso-fortigate-cloud-admin
        ...
        return self._client.put("cmdb", f"system/sso-fortigate-cloud-admin/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        """
        Delete sso-fortigate-cloud-admin
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.sso_fortigate_cloud_admin.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/sso-fortigate-cloud-admin/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if sso-fortigate-cloud-admin exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.sso_fortigate_cloud_admin.exists('obj1'):
            ...     print("Exists")
        """
        try:
