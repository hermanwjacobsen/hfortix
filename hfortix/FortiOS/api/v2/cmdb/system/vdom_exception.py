"""
FortiOS CMDB - System VdomException
...
class VdomException:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.vdom_exception.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.vdom_exception.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", f"system/vdom-exception/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.vdom_exception.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/vdom-exception/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if vdom-exception exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.vdom_exception.exists('obj1'):
            ...     print("Exists")
        """
        try:
