...
API Endpoints:
    GET  /system/console  - Get configuration
    PUT  /system/console  - Update configuration
"""
...
class Console:
    """console settings endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> settings = fgt.api.cmdb.system.console.get()
            >>> print(settings)
        """
        params = {}
        ...
        return self._client.get("cmdb", "system/console", params=params if params else None, vdom=vdom)
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system.console.update(
        ...
        return self._client.put("cmdb", "system/console", data=data, vdom=vdom)
