...
class SsoAdmin:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.sso_admin.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.sso_admin.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", f"system/sso-admin/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.sso_admin.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/sso-admin/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if sso-admin exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.sso_admin.exists('obj1'):
            ...     print("Exists")
        """
        try:
