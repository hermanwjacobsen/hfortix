...
class ArpTable:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.arp_table.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.arp_table.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", f"system/arp-table/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.arp_table.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/arp-table/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if arp-table exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.arp_table.exists('obj1'):
            ...     print("Exists")
        """
        try:
