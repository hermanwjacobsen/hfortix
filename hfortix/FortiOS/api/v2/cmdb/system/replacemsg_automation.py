...
API Endpoints:
    GET    /system.replacemsg/automation           - List all / Get specific
    POST   /system.replacemsg/automation           - Create
    PUT    /system.replacemsg/automation/{name}   - Update
    DELETE /system.replacemsg/automation/{name}   - Delete
"""
