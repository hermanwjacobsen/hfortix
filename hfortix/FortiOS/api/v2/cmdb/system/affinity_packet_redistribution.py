...
API Endpoints:
    GET    /system/affinity-packet-redistribution
    POST   /system/affinity-packet-redistribution
    GET    /system/affinity-packet-redistribution/{id}
    PUT    /system/affinity-packet-redistribution/{id}
    DELETE /system/affinity-packet-redistribution/{id}
"""
