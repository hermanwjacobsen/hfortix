"""
FortiOS CMDB - System ReplacemsgMail
...
class ReplacemsgMail:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.replacemsg_mail.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.replacemsg_mail.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", f"system.replacemsg/mail/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.replacemsg_mail.delete('obj1')
        """
        return self._client.delete("cmdb", f"system.replacemsg/mail/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if replacemsg mail exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.replacemsg_mail.exists('obj1'):
            ...     print("Exists")
        """
        try:
