"""
FortiOS CMDB - System DeviceUpgradeExemptions
...
class DeviceUpgradeExemptions:
    """device-upgrade-exemptions endpoint"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.device_upgrade_exemptions.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.device_upgrade_exemptions.get(name='obj1')
        """
        params = {}
        ...
        path = "system/device-upgrade-exemptions"
        if name:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update device-upgrade-exemptions
        ...
        return self._client.put("cmdb", f"system/device-upgrade-exemptions/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        """
        Delete device-upgrade-exemptions
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.device_upgrade_exemptions.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/device-upgrade-exemptions/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if device-upgrade-exemptions exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.device_upgrade_exemptions.exists('obj1'):
            ...     print("Exists")
        """
        try:
