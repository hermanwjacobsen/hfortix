"""
FortiOS CMDB - System GeoipCountry
...
class GeoipCountry:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.geoip_country.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.geoip_country.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", f"system/geoip-country/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.geoip_country.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/geoip-country/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if geoip-country exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.geoip_country.exists('obj1'):
            ...     print("Exists")
        """
        try:
