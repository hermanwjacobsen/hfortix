...
class FabricVpn:
    """fabric-vpn settings endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> settings = fgt.api.cmdb.system.fabric_vpn.get()
            >>> print(settings)
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", "system/fabric-vpn", data=data, vdom=vdom)
