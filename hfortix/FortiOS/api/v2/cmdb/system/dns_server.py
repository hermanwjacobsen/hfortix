...
API Endpoints:
    GET    /system/dns-server           - List all / Get specific
    POST   /system/dns-server           - Create
    PUT    /system/dns-server/{name}   - Update
    DELETE /system/dns-server/{name}   - Delete
"""
...
class DnsServer:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.dns_server.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.dns_server.get(name='obj1')
        """
        params = {}
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system.dns_server.create(
        ...
        return self._client.post("cmdb", "system/dns-server", data=data, vdom=vdom)
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system.dns_server.update(
            ...     name='obj1',
        ...
        return self._client.put("cmdb", f"system/dns-server/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.dns_server.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/dns-server/{encode_path_component(name)}", vdom=vdom)
    ...
    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        ...
        Examples:
            >>> if fgt.api.cmdb.system.dns_server.exists('obj1'):
            ...     print("Exists")
        """
        try:
