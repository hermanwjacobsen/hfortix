...
API Endpoints:
    GET    /system/geneve           - List all / Get specific
    POST   /system/geneve           - Create
    PUT    /system/geneve/{name}   - Update
    DELETE /system/geneve/{name}   - Delete
"""
...
class Geneve:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.geneve.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.geneve.get(name='obj1')
        """
        params = {}
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system.geneve.create(
        ...
        return self._client.post("cmdb", "system/geneve", data=data, vdom=vdom)
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system.geneve.update(
            ...     name='obj1',
        ...
        return self._client.put("cmdb", f"system/geneve/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.geneve.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/geneve/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if geneve exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.geneve.exists('obj1'):
            ...     print("Exists")
        """
        try:
