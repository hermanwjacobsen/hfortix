...
API Endpoints:
    GET  /system/saml  - Get configuration
    PUT  /system/saml  - Update configuration
"""
...
class Saml:
    """saml settings endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> settings = fgt.api.cmdb.system.saml.get()
            >>> print(settings)
        """
        params = {}
        ...
        return self._client.get("cmdb", "system/saml", params=params if params else None, vdom=vdom)
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system.saml.update(
        ...
        return self._client.put("cmdb", "system/saml", data=data, vdom=vdom)
