...
API Endpoints:
    GET  /system/alarm  - Get configuration
    PUT  /system/alarm  - Update configuration
"""
...
class Alarm:
    """alarm settings endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> settings = fgt.api.cmdb.system.alarm.get()
            >>> print(settings)
        """
        params = {}
        ...
        return self._client.get("cmdb", "system/alarm", params=params if params else None, vdom=vdom)
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system.alarm.update(
        ...
        return self._client.put("cmdb", "system/alarm", data=data, vdom=vdom)
