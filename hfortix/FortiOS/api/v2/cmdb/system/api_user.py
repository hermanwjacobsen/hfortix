...
class ApiUser:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.api_user.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.api_user.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", f"system/api-user/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.api_user.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/api-user/{encode_path_component(name)}", vdom=vdom)
    ...
    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        ...
        Examples:
            >>> if fgt.api.cmdb.system.api_user.exists('obj1'):
            ...     print("Exists")
        """
        try:
