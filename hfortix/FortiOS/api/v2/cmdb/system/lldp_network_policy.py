...
API Endpoints:
    GET    /system.lldp/network-policy           - List all / Get specific
    POST   /system.lldp/network-policy           - Create
    PUT    /system.lldp/network-policy/{name}   - Update
    DELETE /system.lldp/network-policy/{name}   - Delete
"""
