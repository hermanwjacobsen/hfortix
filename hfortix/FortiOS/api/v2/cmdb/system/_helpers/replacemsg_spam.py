"""
Validation helpers for system replacemsg_spam endpoint.
...
def validate_replacemsg_spam_get(
    attr: str | None = None,
...
def validate_replacemsg_spam_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating replacemsg_spam.
