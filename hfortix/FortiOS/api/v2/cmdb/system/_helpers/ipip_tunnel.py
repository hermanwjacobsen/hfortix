"""
Validation helpers for system ipip_tunnel endpoint.
...
def validate_ipip_tunnel_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating ipip_tunnel.
...
def validate_ipip_tunnel_delete(
    name: str | None = None,
) -> tuple[bool, str | None]:
    """
