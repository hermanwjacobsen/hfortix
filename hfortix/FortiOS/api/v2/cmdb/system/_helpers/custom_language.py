"""
Validation helpers for system custom_language endpoint.
...
def validate_custom_language_get(
    attr: str | None = None,
...
def validate_custom_language_put(
...
def validate_custom_language_delete(
    name: str | None = None,
) -> tuple[bool, str | None]:
    """
