"""
Validation helpers for system replacemsg_mail endpoint.
...
def validate_replacemsg_mail_get(
    attr: str | None = None,
...
def validate_replacemsg_mail_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating replacemsg_mail.
