"""
Validation helpers for system sso_admin endpoint.
...
def validate_sso_admin_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating sso_admin.
