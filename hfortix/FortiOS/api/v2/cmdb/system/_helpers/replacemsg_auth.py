"""
Validation helpers for system replacemsg_auth endpoint.
...
def validate_replacemsg_auth_get(
    attr: str | None = None,
...
def validate_replacemsg_auth_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating replacemsg_auth.
