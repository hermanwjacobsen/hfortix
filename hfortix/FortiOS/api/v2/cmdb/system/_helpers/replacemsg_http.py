"""
Validation helpers for system replacemsg_http endpoint.
...
def validate_replacemsg_http_get(
    attr: str | None = None,
...
def validate_replacemsg_http_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating replacemsg_http.
