"""
Validation helpers for system sit_tunnel endpoint.
...
def validate_sit_tunnel_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating sit_tunnel.
...
def validate_sit_tunnel_delete(
    name: str | None = None,
) -> tuple[bool, str | None]:
    """
