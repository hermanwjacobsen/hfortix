"""
Validation helpers for system replacemsg_utm endpoint.
...
def validate_replacemsg_utm_get(
    attr: str | None = None,
...
def validate_replacemsg_utm_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating replacemsg_utm.
