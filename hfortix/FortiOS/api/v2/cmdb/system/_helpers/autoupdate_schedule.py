"""
Validation helpers for system autoupdate_schedule endpoint.
...
VALID_BODY_FREQUENCY = ["every", "daily", "weekly", "automatic"]
VALID_BODY_DAY = [
    "Sunday",
    "Monday",
    "Tuesday",
...
def validate_autoupdate_schedule_get(
    attr: str | None = None,
...
def validate_autoupdate_schedule_put(
