"""
Validation helpers for system sdn_proxy endpoint.
...
VALID_BODY_TYPE = ["general", "fortimanager"]
...
def validate_sdn_proxy_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating sdn_proxy.
