...
API Endpoints:
    GET  /system/settings  - Get configuration
    PUT  /system/settings  - Update configuration
"""
...
class Settings:
    """settings settings endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> settings = fgt.api.cmdb.system.settings.get()
            >>> print(settings)
        """
        params = {}
        ...
        return self._client.get("cmdb", "system/settings", params=params if params else None, vdom=vdom)
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system.settings.update(
        ...
        return self._client.put("cmdb", "system/settings", data=data, vdom=vdom)
