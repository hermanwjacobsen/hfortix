...
API Endpoints:
    GET  /system/auto-install  - Get configuration
    PUT  /system/auto-install  - Update configuration
"""
...
class AutoInstall:
    """auto-install settings endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> settings = fgt.api.cmdb.system.auto_install.get()
            >>> print(settings)
        """
        params = {}
        ...
        return self._client.get("cmdb", "system/auto-install", params=params if params else None, vdom=vdom)
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system.auto_install.update(
        ...
        return self._client.put("cmdb", "system/auto-install", data=data, vdom=vdom)
