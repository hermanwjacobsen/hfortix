...
class StandaloneCluster:
    """standalone-cluster settings endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Get standalone-cluster settings
        ...
        Examples:
            ...
            >>> settings = fgt.api.cmdb.system.standalone_cluster.get()
            >>> print(settings)
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update standalone-cluster settings
        ...
        return self._client.put("cmdb", "system/standalone-cluster", data=data, vdom=vdom)
