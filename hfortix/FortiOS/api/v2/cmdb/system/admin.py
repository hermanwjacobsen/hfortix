...
API Endpoints:
    GET    /system/admin           - List all / Get specific
    POST   /system/admin           - Create
    PUT    /system/admin/{name}   - Update
    DELETE /system/admin/{name}   - Delete
"""
...
class Admin:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.admin.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.admin.get(name='obj1')
        """
        params = {}
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system.admin.create(
        ...
        return self._client.post("cmdb", "system/admin", data=data, vdom=vdom)
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system.admin.update(
            ...     name='obj1',
        ...
        return self._client.put("cmdb", f"system/admin/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.admin.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/admin/{encode_path_component(name)}", vdom=vdom)
    ...
    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        ...
        Examples:
            >>> if fgt.api.cmdb.system.admin.exists('obj1'):
            ...     print("Exists")
        """
        try:
