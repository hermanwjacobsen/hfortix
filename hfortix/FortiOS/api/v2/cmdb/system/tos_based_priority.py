"""
FortiOS CMDB - Cmdb System Tos Based Priority

Configuration endpoint for managing cmdb system tos based priority objects.
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.system.tos_based_priority.get(name="item_name")
    >>>
    >>> # Create new item (use POST)
    >>> result = fgt.api.cmdb.system.tos_based_priority.post(
    ...     name="new_item",
    ...
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.system.tos_based_priority.delete(name="item_name")
...
class TosBasedPriority:
    ...
    Provides CRUD operations for FortiOS tosbasedpriority configuration.
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        # Build endpoint path
        if id:
            endpoint = f"/system/tos-based-priority/{id}"
        else:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            id: Item ID. (optional)
            tos: Value of the ToS byte in the IP datagram header (0-15, 8: minimize delay, 4: maximize throughput, 2: maximize reliability, 1: minimize monetary cost, and 0: default service). (optional)
            priority: ToS based priority level to low, medium or high (these priorities match firewall traffic shaping priorities) (default = medium). (optional)
            vdom: Virtual domain name, or False to skip. Handled by HTTPClient.
            raw_json: If True, return full API response with metadata. If False, return only results.
            **kwargs: Additional query parameters (filter, sort, start, count, format, etc.)
