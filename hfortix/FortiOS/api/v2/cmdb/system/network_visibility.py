...
class NetworkVisibility:
    """network-visibility settings endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Get network-visibility settings
        ...
        Examples:
            ...
            >>> settings = fgt.api.cmdb.system.network_visibility.get()
            >>> print(settings)
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update network-visibility settings
        ...
        return self._client.put("cmdb", "system/network-visibility", data=data, vdom=vdom)
