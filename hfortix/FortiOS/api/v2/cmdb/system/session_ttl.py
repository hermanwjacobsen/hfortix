"""
FortiOS CMDB - System SessionTtl
...
class SessionTtl:
    """session-ttl settings endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> settings = fgt.api.cmdb.system.session_ttl.get()
            >>> print(settings)
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", "system/session-ttl", data=data, vdom=vdom)
