"""
FortiOS CMDB - System AutomationStitch
...
class AutomationStitch:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.automation_stitch.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.automation_stitch.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", f"system/automation-stitch/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.automation_stitch.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/automation-stitch/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if automation-stitch exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.automation_stitch.exists('obj1'):
            ...     print("Exists")
        """
        try:
