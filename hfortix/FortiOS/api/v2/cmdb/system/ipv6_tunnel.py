"""
FortiOS CMDB - System Ipv6Tunnel
...
class Ipv6Tunnel:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.ipv6_tunnel.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.ipv6_tunnel.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", f"system/ipv6-tunnel/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.ipv6_tunnel.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/ipv6-tunnel/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if ipv6-tunnel exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.ipv6_tunnel.exists('obj1'):
            ...     print("Exists")
        """
        try:
