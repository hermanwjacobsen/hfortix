"""
FortiOS CMDB - System VirtualWirePair
...
class VirtualWirePair:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.virtual_wire_pair.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.virtual_wire_pair.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", f"system/virtual-wire-pair/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.virtual_wire_pair.delete('obj1')
        """
        return self._client.delete("cmdb", f"system/virtual-wire-pair/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if virtual-wire-pair exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.virtual_wire_pair.exists('obj1'):
            ...     print("Exists")
        """
        try:
