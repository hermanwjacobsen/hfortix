"""
FortiOS CMDB - System SnmpRmonStat
...
class SnmpRmonStat:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> # Get all
            >>> result = fgt.api.cmdb.system.snmp_rmon_stat.get()
            
            >>> # Get specific by name
            >>> result = fgt.api.cmdb.system.snmp_rmon_stat.get(name='obj1')
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", f"system.snmp/rmon-stat/{encode_path_component(name)}", data=data, vdom=vdom)
    ...
    def delete(
        ...
        Examples:
            >>> result = fgt.api.cmdb.system.snmp_rmon_stat.delete('obj1')
        """
        return self._client.delete("cmdb", f"system.snmp/rmon-stat/{encode_path_component(name)}", vdom=vdom)

    def exists(self, name: str, vdom: Optional[Union[str, bool]] = None) -> bool:
        """
        Check if snmp rmon-stat exists
        ...
        Examples:
            >>> if fgt.api.cmdb.system.snmp_rmon_stat.exists('obj1'):
            ...     print("Exists")
        """
        try:
