    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            vdom_dns: Enable/disable configuring DNS servers for the current VDOM. (optional)
            ...
            ip6_primary: Primary IPv6 DNS server IP address for the VDOM. (optional)
            ip6_secondary: Secondary IPv6 DNS server IP address for the VDOM. (optional)
            source_ip: Source IP for communications with the DNS server. (optional)
