...
class VdomDns:
    """vdom-dns settings endpoint (singleton)"""
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> settings = fgt.api.cmdb.system.vdom_dns.get()
            >>> print(settings)
        """
        params = {}
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        return self._client.put("cmdb", "system/vdom-dns", data=data, vdom=vdom)
