"""
Validation helpers for dlp dictionary endpoint.
...
def validate_dictionary_post(
    payload: dict[str, Any],
) -> tuple[bool, str | None]:
    """
    Validate POST request payload for creating dictionary.
...
def validate_dictionary_delete(
    name: str | None = None,
) -> tuple[bool, str | None]:
    """
