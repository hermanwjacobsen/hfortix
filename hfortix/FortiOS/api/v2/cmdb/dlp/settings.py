"""
FortiOS CMDB - Cmdb Dlp Settings
...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.dlp.settings.get(name="item_name")
    >>>
    >>> # Create new item (use POST)
    >>> result = fgt.api.cmdb.dlp.settings.post(
    ...     name="new_item",
    ...
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.dlp.settings.delete(name="item_name")
