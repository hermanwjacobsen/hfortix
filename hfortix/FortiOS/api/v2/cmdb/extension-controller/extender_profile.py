"""
FortiOS CMDB - Extension-controller ExtenderProfile

API Endpoints:
    GET    /extension-controller/extender-profile
    POST   /extension-controller/extender-profile
    GET    /extension-controller/extender-profile/{name}
    PUT    /extension-controller/extender-profile/{name}
    DELETE /extension-controller/extender-profile/{name}
"""
...
class ExtenderProfile:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        # Build endpoint path
        if name:
            endpoint = f"/extension-controller/extender-profile/{name}"
        else:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        if cellular is not None:
            data_payload['cellular'] = cellular
        if wifi is not None:
