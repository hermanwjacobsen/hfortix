...
Example Usage:
    ...
    >>> item = fgt.api.cmdb.ips.sensor.get(name="item_name")
    >>>
    ...
    >>>
    >>> # Delete item
    >>> result = fgt.api.cmdb.ips.sensor.delete(name="item_name")
...
class Sensor:
    ...
    Provides CRUD operations for FortiOS sensor configuration.
