"""
FortiOS LOG - Log Cifs

Log retrieval endpoint for log cifs logs.
...
class CIFS:
    ...
    Provides read-only access for FortiOS cifs data.
    ...
    def __init__(self, client: "IHTTPClient", storage: str = "disk") -> None:
        ...
        self.raw = RawResource(client, "cifs", storage)
        self._resource = LogResource(client, "cifs", storage)
