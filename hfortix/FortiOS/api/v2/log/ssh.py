...
Log retrieval endpoint for log ssh logs.
...
class SSH:
    ...
    Provides read-only access for FortiOS ssh data.
    ...
    def __init__(self, client: "IHTTPClient", storage: str = "disk") -> None:
        ...
        self.raw = RawResource(client, "ssh", storage)
        self._resource = LogResource(client, "ssh", storage)
