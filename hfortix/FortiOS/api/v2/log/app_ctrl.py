"""
FortiOS LOG - Log App Ctrl

Log retrieval endpoint for log app ctrl logs.
...
class AppCtrl:
    ...
    Provides read-only access for FortiOS appctrl data.
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Get App Control logs (formatted).

        Supports dual approach:
        1. Individual parameters: get(rows=100, filter='app==Facebook')
        2. Payload dict: get(payload_dict={'rows': 100, 'filter': 'app==Facebook'})
