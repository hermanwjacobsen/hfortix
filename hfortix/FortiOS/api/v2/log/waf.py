...
Log retrieval endpoint for log waf logs.
...
class WAF:
    ...
    Provides read-only access for FortiOS waf data.
    ...
    def __init__(self, client: "HTTPClient", storage: str = "disk") -> None:
        ...
        self.raw = RawResource(client, "waf", storage)
        self._resource = LogResource(client, "waf", storage)
