...
Log retrieval endpoint for log ssl logs.
...
class SSL:
    ...
    Provides read-only access for FortiOS ssl data.
    ...
    def __init__(self, client: "IHTTPClient", storage: str = "disk") -> None:
        ...
        self.raw = RawResource(client, "ssl", storage)
        self._resource = LogResource(client, "ssl", storage)
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        1. Individual parameters: get(rows=100, filter='sni=="example.com"')
        2. Payload dict: get(payload_dict={'rows': 100, 'filter': 'sni=="example.com"'})
