"""
FortiOS Log Disk - Virus

Virus/Antivirus logs with special archive support for quarantined files.
"""
...
class Virus:
    ...
    Supports: raw and formatted logs (archive via virus_archive)
    """
