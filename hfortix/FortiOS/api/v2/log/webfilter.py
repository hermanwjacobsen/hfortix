"""
FortiOS LOG - Log Webfilter

Log retrieval endpoint for log webfilter logs.
...
Example Usage:
    ...
    >>> data = fgt.api.log.webfilter.get()
    >>> 
...
class Webfilter:
    """
    Webfilter Operations.
    
    Provides read-only access for FortiOS webfilter data.
    ...
    def __init__(self, client: "HTTPClient", storage: str = "disk") -> None:
        ...
        self.raw = RawResource(client, "webfilter", storage)
        self._resource = LogResource(client, "webfilter", storage)
    ...
    def get(
        ...
        **kwargs: Any
        ...
        1. Individual parameters: get(rows=100, filter='url==malicious')
        2. Payload dict: get(payload_dict={'rows': 100, 'filter': 'url==malicious'})
