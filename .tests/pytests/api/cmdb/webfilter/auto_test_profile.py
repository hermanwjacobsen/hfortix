"""
Auto-generated basic tests for cmdb.webfilter/profile

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/webfilter.profile.json
Category: cmdb
...
endpoint = fgt.api.cmdb.webfilter.profile
...
class TestAutoProfileValidators:
    ...
    def auto_test_validator_import(self):
        ...
        try:
            from hfortix_fortios.api.v2.cmdb.webfilter._helpers import profile as validators
            print(f"✅ Successfully imported validators for profile")
            
            # Check validator functions exist (they use HTTP method naming: post, put, get)
            assert hasattr(validators, "validate_webfilter_profile_post")
            assert hasattr(validators, "validate_webfilter_profile_put")
...
class TestAutoProfileEnums:
    ...
    def auto_test_enum_options(self):
        ...
        valid_values = ['activexfilter', 'cookiefilter', 'javafilter', 'block-invalid-url', 'jscript', 'js', 'vbs', 'unknown', 'intrinsic', 'wf-referer', 'wf-cookie', 'per-user-bal']
    ...
    def auto_test_enum_https_replacemsg(self):
        """Test enum field https-replacemsg validation."""
        from hfortix_fortios.api.v2.cmdb.webfilter._helpers import profile as validators
        ...
        # Test each valid value
        for value in valid_values:
            config = {"https-replacemsg": value}
            # Validators should accept any valid enum value
            # Note: Full validation requires all required fields
            print(f"   Valid enum value: https-replacemsg={value}")
        
        print(f"✅ Enum field https-replacemsg has {len(valid_values)} valid values")




# Metadata for test discovery
TEST_ENDPOINT = "cmdb/webfilter/profile"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/webfilter.profile.json"
