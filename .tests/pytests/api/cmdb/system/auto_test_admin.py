"""
Auto-generated basic tests for cmdb.system/replacemsg/admin

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/system.replacemsg.admin.json
Category: cmdb
...
endpoint = fgt.api.cmdb.system.replacemsg.admin
...
class TestAutoAdminValidators:
    ...
    def auto_test_validator_import(self):
        ...
        try:
            from hfortix_fortios.api.v2.cmdb.system.replacemsg._helpers import admin as validators
            print(f"✅ Successfully imported validators for admin")
            
            # Check validator functions exist (they use HTTP method naming: post, put, get)
            assert hasattr(validators, "validate_system_replacemsg_admin_post")
            assert hasattr(validators, "validate_system_replacemsg_admin_put")
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_admin_create(config)
...
TEST_ENDPOINT = "cmdb/system/replacemsg/admin"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/system.replacemsg.admin.json"
