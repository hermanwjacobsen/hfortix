...
class TestAutoPhysicalSwitchGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - retrieve physical-switch configuration."""
        try:
        ...
        print(f"✅ Retrieved physical-switch configuration (singleton)")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoPhysicalSwitchExists:
