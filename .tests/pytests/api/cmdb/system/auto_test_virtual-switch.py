...
class TestAutoVirtualSwitchGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - retrieve virtual-switch configuration."""
        try:
        ...
        print(f"✅ Retrieved virtual-switch configuration (singleton)")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoVirtualSwitchExists:
