...
class TestAutoIpsecAggregateGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all ipsec-aggregate items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} ipsec-aggregate items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific ipsec-aggregate by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing ipsec-aggregate items to test with")
        ...
        print(f"✅ Retrieved ipsec-aggregate name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoIpsecAggregateExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing ipsec-aggregate items to test exists() with")
...
class TestAutoIpsecAggregateValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_ipsec_aggregate_create(config)
