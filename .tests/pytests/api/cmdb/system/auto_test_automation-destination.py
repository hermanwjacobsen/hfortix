...
class TestAutoAutomationDestinationGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all automation-destination items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} automation-destination items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific automation-destination by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing automation-destination items to test with")
        ...
        print(f"✅ Retrieved automation-destination name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoAutomationDestinationExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing automation-destination items to test exists() with")
