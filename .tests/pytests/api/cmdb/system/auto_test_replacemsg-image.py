...
class TestAutoReplacemsgImageGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all replacemsg-image items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} replacemsg-image items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific replacemsg-image by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing replacemsg-image items to test with")
        ...
        print(f"✅ Retrieved replacemsg-image name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoReplacemsgImageExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing replacemsg-image items to test exists() with")
