...
class TestAutoAutomationConditionGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all automation-condition items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} automation-condition items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific automation-condition by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing automation-condition items to test with")
        ...
        print(f"✅ Retrieved automation-condition name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoAutomationConditionExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing automation-condition items to test exists() with")
...
class TestAutoAutomationConditionValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_automation_condition_create(config)
