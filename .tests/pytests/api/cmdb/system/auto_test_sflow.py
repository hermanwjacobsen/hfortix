...
Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/system.sflow.json
Category: cmdb
...
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/system.sflow.json"
