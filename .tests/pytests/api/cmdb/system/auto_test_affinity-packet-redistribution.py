...
Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/system.affinity-packet-redistribution.json
Category: cmdb
...
class TestAutoAffinityPacketRedistributionValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_affinity_packet_redistribution_create(config)
...
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/system.affinity-packet-redistribution.json"
