...
class TestAutoDns64Get:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - retrieve dns64 configuration."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved dns64 configuration (singleton)")
...
class TestAutoDns64Validators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_dns64_create(config)
