...
class TestAutoDedicatedMgmtGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - retrieve dedicated-mgmt configuration."""
        try:
        ...
        print(f"✅ Retrieved dedicated-mgmt configuration (singleton)")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoDedicatedMgmtExists:
