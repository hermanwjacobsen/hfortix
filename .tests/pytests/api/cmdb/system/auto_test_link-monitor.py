...
class TestAutoLinkMonitorGet:
    ...
    def auto_test_get_list_all(self):
        """Test GET - list all link-monitor items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} link-monitor items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific link-monitor by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing link-monitor items to test with")
        ...
        print(f"✅ Retrieved link-monitor name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoLinkMonitorExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing link-monitor items to test exists() with")
...
class TestAutoLinkMonitorValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_link_monitor_create(config)
