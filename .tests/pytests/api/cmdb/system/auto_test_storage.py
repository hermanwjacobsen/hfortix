...
class TestAutoStorageGet:
    ...
    def auto_test_get_list_all(self):
        """Test GET - list all storage items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} storage items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific storage by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing storage items to test with")
        ...
        print(f"✅ Retrieved storage name={mkey_value}")
...
class TestAutoStorageExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing storage items to test exists() with")
