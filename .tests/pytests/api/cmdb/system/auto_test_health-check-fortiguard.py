...
class TestAutoHealthCheckFortiguardGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all health-check-fortiguard items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} health-check-fortiguard items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific health-check-fortiguard by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing health-check-fortiguard items to test with")
        ...
        print(f"✅ Retrieved health-check-fortiguard name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoHealthCheckFortiguardExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing health-check-fortiguard items to test exists() with")
...
class TestAutoHealthCheckFortiguardValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_health_check_fortiguard_create(config)
