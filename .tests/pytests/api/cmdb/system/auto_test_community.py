...
Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/system.snmp.community.json
Category: cmdb
...
class TestAutoCommunityValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_community_create(config)
...
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/system.snmp.community.json"
