...
class TestAutoPppoeInterfaceGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all pppoe-interface items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} pppoe-interface items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific pppoe-interface by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing pppoe-interface items to test with")
        ...
        print(f"✅ Retrieved pppoe-interface name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoPppoeInterfaceExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing pppoe-interface items to test exists() with")
...
class TestAutoPppoeInterfaceValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_pppoe_interface_create(config)
