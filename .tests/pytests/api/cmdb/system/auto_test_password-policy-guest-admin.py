...
class TestAutoPasswordPolicyGuestAdminGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - retrieve password-policy-guest-admin configuration."""
        try:
        ...
        print(f"✅ Retrieved password-policy-guest-admin configuration (singleton)")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoPasswordPolicyGuestAdminExists:
