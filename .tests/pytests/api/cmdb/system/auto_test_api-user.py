...
class TestAutoApiUserGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all api-user items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} api-user items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific api-user by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing api-user items to test with")
        ...
        print(f"✅ Retrieved api-user name={mkey_value}")
...
class TestAutoApiUserExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing api-user items to test exists() with")
...
class TestAutoApiUserValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_api_user_create(config)
