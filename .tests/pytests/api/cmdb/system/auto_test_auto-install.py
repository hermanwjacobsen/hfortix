...
class TestAutoAutoInstallGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - retrieve auto-install configuration."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved auto-install configuration (singleton)")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoAutoInstallExists:
