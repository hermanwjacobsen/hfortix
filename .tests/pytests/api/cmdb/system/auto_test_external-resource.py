...
class TestAutoExternalResourceGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all external-resource items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} external-resource items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific external-resource by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing external-resource items to test with")
        ...
        print(f"✅ Retrieved external-resource name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoExternalResourceExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing external-resource items to test exists() with")
...
class TestAutoExternalResourceValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_external_resource_create(config)
