...
class TestAutoCloudServiceGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all cloud-service items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} cloud-service items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific cloud-service by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing cloud-service items to test with")
        ...
        print(f"✅ Retrieved cloud-service name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoCloudServiceExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing cloud-service items to test exists() with")
