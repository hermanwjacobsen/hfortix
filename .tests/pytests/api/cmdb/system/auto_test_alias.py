"""
Auto-generated basic tests for cmdb.system/alias

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/system.alias.json
Category: cmdb
Endpoint: /cmdb/system/alias

These are BASIC automated tests. For comprehensive testing, create
manual tests in test_alias.py
...
endpoint = fgt.api.cmdb.system.alias


@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoAliasGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all alias items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} alias items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific alias by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing alias items to test with")
        ...
        print(f"✅ Retrieved alias name={mkey_value}")
...
class TestAutoAliasExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing alias items to test exists() with")
...
TEST_ENDPOINT = "cmdb/system/alias"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/system.alias.json"
