...
class TestAutoVxlanGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all vxlan items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} vxlan items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific vxlan by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing vxlan items to test with")
        ...
        print(f"✅ Retrieved vxlan name={mkey_value}")
...
class TestAutoVxlanExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing vxlan items to test exists() with")
...
class TestAutoVxlanValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_vxlan_create(config)
