...
class TestAutoVdomLinkGet:
    ...
    def auto_test_get_list_all(self):
        """Test GET - list all vdom-link items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} vdom-link items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific vdom-link by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing vdom-link items to test with")
        ...
        print(f"✅ Retrieved vdom-link name={mkey_value}")
...
class TestAutoVdomLinkExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing vdom-link items to test exists() with")
