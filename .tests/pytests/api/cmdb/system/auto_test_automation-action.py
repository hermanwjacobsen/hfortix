...
class TestAutoAutomationActionGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all automation-action items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} automation-action items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific automation-action by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing automation-action items to test with")
        ...
        print(f"✅ Retrieved automation-action name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoAutomationActionExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing automation-action items to test exists() with")
...
class TestAutoAutomationActionValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_automation_action_create(config)
