...
class TestAutoOverrideSettingGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - retrieve override-setting configuration."""
        try:
        ...
        print(f"✅ Retrieved override-setting configuration (singleton)")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoOverrideSettingExists:
...
class TestAutoOverrideSettingValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_override_setting_create(config)
...
@pytest.mark.validator
@pytest.mark.parallel_safe
class TestAutoOverrideSettingEnums:
