...
class TestAutoFortigateGet:
    ...
    def auto_test_get_list_all(self):
        """Test GET - list all fortigate items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} fortigate items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific fortigate by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing fortigate items to test with")
        ...
        print(f"✅ Retrieved fortigate name={mkey_value}")
...
class TestAutoFortigateExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing fortigate items to test exists() with")
...
class TestAutoFortigateValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_fortigate_create(config)
