...
class TestAutoInternetServiceGroupGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all internet-service-group items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} internet-service-group items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific internet-service-group by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing internet-service-group items to test with")
        ...
        print(f"✅ Retrieved internet-service-group name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoInternetServiceGroupExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing internet-service-group items to test exists() with")
