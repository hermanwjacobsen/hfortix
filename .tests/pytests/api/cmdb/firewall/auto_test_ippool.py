...
class TestAutoIppoolGet:
    ...
    def auto_test_get_list_all(self):
        """Test GET - list all ippool items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} ippool items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific ippool by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing ippool items to test with")
        ...
        print(f"✅ Retrieved ippool name={mkey_value}")
...
class TestAutoIppoolExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing ippool items to test exists() with")
...
class TestAutoIppoolValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_ippool_create(config)
