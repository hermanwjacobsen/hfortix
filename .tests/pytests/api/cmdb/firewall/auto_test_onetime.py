...
class TestAutoOnetimeGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all onetime items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} onetime items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific onetime by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing onetime items to test with")
        ...
        print(f"✅ Retrieved onetime name={mkey_value}")
...
class TestAutoOnetimeExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing onetime items to test exists() with")
...
class TestAutoOnetimeValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_onetime_create(config)
