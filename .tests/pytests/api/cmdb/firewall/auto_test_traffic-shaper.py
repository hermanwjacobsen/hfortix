...
class TestAutoTrafficShaperGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all traffic-shaper items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} traffic-shaper items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific traffic-shaper by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing traffic-shaper items to test with")
        ...
        print(f"✅ Retrieved traffic-shaper name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoTrafficShaperExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing traffic-shaper items to test exists() with")
