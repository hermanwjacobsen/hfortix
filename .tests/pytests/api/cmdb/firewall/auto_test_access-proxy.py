"""
Auto-generated basic tests for cmdb.firewall/access_proxy

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/firewall.access-proxy.json
Category: cmdb
Endpoint: /cmdb/firewall/access-proxy

These are BASIC automated tests. For comprehensive testing, create
manual tests in test_access-proxy.py
...
endpoint = fgt.api.cmdb.firewall.access_proxy


@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoAccessProxyGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all access-proxy items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} access-proxy items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific access-proxy by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing access-proxy items to test with")
        ...
        print(f"✅ Retrieved access-proxy name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoAccessProxyExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing access-proxy items to test exists() with")


@pytest.mark.validator
@pytest.mark.parallel_safe
class TestAutoAccessProxyValidators:
    """Auto-generated validator tests."""
    
    def auto_test_validator_import(self):
        """Test that validators can be imported."""
        try:
            from hfortix_fortios.api.v2.cmdb.firewall._helpers import access_proxy as validators
            print(f"✅ Successfully imported validators for access-proxy")
            
            # Check validator functions exist (they use HTTP method naming: post, put, get)
            assert hasattr(validators, "validate_firewall_access_proxy_post")
            assert hasattr(validators, "validate_firewall_access_proxy_put")
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_access_proxy_create(config)
...
@pytest.mark.validator
@pytest.mark.parallel_safe
class TestAutoAccessProxyEnums:
...
TEST_ENDPOINT = "cmdb/firewall/access_proxy"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/firewall.access-proxy.json"
