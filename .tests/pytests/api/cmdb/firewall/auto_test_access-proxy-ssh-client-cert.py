...
class TestAutoAccessProxySshClientCertGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all access-proxy-ssh-client-cert items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} access-proxy-ssh-client-cert items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific access-proxy-ssh-client-cert by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing access-proxy-ssh-client-cert items to test with")
        ...
        print(f"✅ Retrieved access-proxy-ssh-client-cert name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoAccessProxySshClientCertExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing access-proxy-ssh-client-cert items to test exists() with")
...
class TestAutoAccessProxySshClientCertValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_access_proxy_ssh_client_cert_create(config)
