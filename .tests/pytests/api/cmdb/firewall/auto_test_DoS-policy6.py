...
Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/firewall.DoS-policy6.json
Category: cmdb
...
class TestAutoDosPolicy6Validators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_DoS_policy6_create(config)
...
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/firewall.DoS-policy6.json"
