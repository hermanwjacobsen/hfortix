...
class TestAutoProxyAddressGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all proxy-address items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} proxy-address items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific proxy-address by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing proxy-address items to test with")
        ...
        print(f"✅ Retrieved proxy-address name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoProxyAddressExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing proxy-address items to test exists() with")
...
class TestAutoProxyAddressValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_proxy_address_create(config)
