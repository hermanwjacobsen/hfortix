...
class TestAutoShapingPolicyGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all shaping-policy items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} shaping-policy items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific shaping-policy by id."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing shaping-policy items to test with")
        ...
        print(f"✅ Retrieved shaping-policy id={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoShapingPolicyExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing shaping-policy items to test exists() with")
...
class TestAutoShapingPolicyValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_shaping_policy_create(config)
