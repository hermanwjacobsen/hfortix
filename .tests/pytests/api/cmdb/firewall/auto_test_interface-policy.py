...
class TestAutoInterfacePolicyGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all interface-policy items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} interface-policy items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific interface-policy by policyid."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing interface-policy items to test with")
        ...
        print(f"✅ Retrieved interface-policy policyid={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoInterfacePolicyExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing interface-policy items to test exists() with")
...
class TestAutoInterfacePolicyValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_interface_policy_create(config)
