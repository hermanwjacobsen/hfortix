...
class TestAutoSslSshProfileGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all ssl-ssh-profile items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} ssl-ssh-profile items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific ssl-ssh-profile by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing ssl-ssh-profile items to test with")
        ...
        print(f"✅ Retrieved ssl-ssh-profile name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoSslSshProfileExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing ssl-ssh-profile items to test exists() with")
...
class TestAutoSslSshProfileValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_ssl_ssh_profile_create(config)
