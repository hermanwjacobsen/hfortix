...
Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/firewall.country.json
Category: cmdb
...
class TestAutoCountryValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_country_create(config)
...
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/firewall.country.json"
