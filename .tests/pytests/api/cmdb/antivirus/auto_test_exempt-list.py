...
class TestAutoExemptListGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all exempt-list items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} exempt-list items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific exempt-list by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing exempt-list items to test with")
        ...
        print(f"✅ Retrieved exempt-list name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoExemptListExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing exempt-list items to test exists() with")
...
class TestAutoExemptListValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_exempt_list_create(config)
