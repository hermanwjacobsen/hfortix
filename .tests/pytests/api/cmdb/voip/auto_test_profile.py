"""
Auto-generated basic tests for cmdb.voip/profile

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/voip.profile.json
Category: cmdb
...
endpoint = fgt.api.cmdb.voip.profile
...
class TestAutoProfileValidators:
    ...
    def auto_test_validator_import(self):
        ...
        try:
            from hfortix_fortios.api.v2.cmdb.voip._helpers import profile as validators
            print(f"✅ Successfully imported validators for profile")
            
            # Check validator functions exist (they use HTTP method naming: post, put, get)
            assert hasattr(validators, "validate_voip_profile_post")
            assert hasattr(validators, "validate_voip_profile_put")
...
TEST_ENDPOINT = "cmdb/voip/profile"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/voip.profile.json"
