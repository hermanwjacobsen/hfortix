...
class TestAutoSaasApplicationGet:
    ...
    def auto_test_get_list_all(self):
        """Test GET - list all saas-application items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} saas-application items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific saas-application by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing saas-application items to test with")
        ...
        print(f"✅ Retrieved saas-application name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoSaasApplicationExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing saas-application items to test exists() with")
