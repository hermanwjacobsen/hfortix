"""
Auto-generated basic tests for cmdb.dlp/profile

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/dlp.profile.json
Category: cmdb
...
endpoint = fgt.api.cmdb.dlp.profile
...
class TestAutoProfileValidators:
    ...
    def auto_test_validator_import(self):
        ...
        try:
            from hfortix_fortios.api.v2.cmdb.dlp._helpers import profile as validators
            print(f"✅ Successfully imported validators for profile")
            
            # Check validator functions exist (they use HTTP method naming: post, put, get)
            assert hasattr(validators, "validate_dlp_profile_post")
            assert hasattr(validators, "validate_dlp_profile_put")
...
class TestAutoProfileEnums:
    ...
    def auto_test_enum_dlp_log(self):
        """Test enum field dlp-log validation."""
        from hfortix_fortios.api.v2.cmdb.dlp._helpers import profile as validators
        ...
        # Test each valid value
        for value in valid_values:
            config = {"dlp-log": value}
            # Validators should accept any valid enum value
            # Note: Full validation requires all required fields
            print(f"   Valid enum value: dlp-log={value}")
        
        print(f"✅ Enum field dlp-log has {len(valid_values)} valid values")
...
TEST_ENDPOINT = "cmdb/dlp/profile"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/dlp.profile.json"
