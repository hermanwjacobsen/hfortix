...
class TestAutoDataTypeGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all data-type items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} data-type items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific data-type by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing data-type items to test with")
        ...
        print(f"✅ Retrieved data-type name={mkey_value}")
...
class TestAutoDataTypeExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing data-type items to test exists() with")
...
class TestAutoDataTypeValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_data_type_create(config)
