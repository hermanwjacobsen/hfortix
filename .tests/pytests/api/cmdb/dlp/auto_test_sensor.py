"""
Auto-generated basic tests for cmdb.dlp/sensor

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/dlp.sensor.json
Category: cmdb
...
endpoint = fgt.api.cmdb.dlp.sensor
...
class TestAutoSensorValidators:
    ...
    def auto_test_validator_import(self):
        ...
        try:
            from hfortix_fortios.api.v2.cmdb.dlp._helpers import sensor as validators
            print(f"✅ Successfully imported validators for sensor")
            
            # Check validator functions exist (they use HTTP method naming: post, put, get)
            assert hasattr(validators, "validate_dlp_sensor_post")
            assert hasattr(validators, "validate_dlp_sensor_put")
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_sensor_create(config)
...
class TestAutoSensorEnums:
    ...
    def auto_test_enum_match_type(self):
        ...
        valid_values = ['match-all', 'match-any', 'match-eval']
...
TEST_ENDPOINT = "cmdb/dlp/sensor"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/dlp.sensor.json"
