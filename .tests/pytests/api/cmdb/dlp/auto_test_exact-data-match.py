...
class TestAutoExactDataMatchGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all exact-data-match items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} exact-data-match items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific exact-data-match by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing exact-data-match items to test with")
        ...
        print(f"✅ Retrieved exact-data-match name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoExactDataMatchExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing exact-data-match items to test exists() with")
...
class TestAutoExactDataMatchValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_exact_data_match_create(config)
