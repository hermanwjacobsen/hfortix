...
class TestAutoH2qpConnCapabilityGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all h2qp-conn-capability items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} h2qp-conn-capability items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific h2qp-conn-capability by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing h2qp-conn-capability items to test with")
        ...
        print(f"✅ Retrieved h2qp-conn-capability name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoH2qpConnCapabilityExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing h2qp-conn-capability items to test exists() with")
