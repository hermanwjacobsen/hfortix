...
class TestAutoH2qpWanMetricGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all h2qp-wan-metric items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} h2qp-wan-metric items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific h2qp-wan-metric by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing h2qp-wan-metric items to test with")
        ...
        print(f"✅ Retrieved h2qp-wan-metric name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoH2qpWanMetricExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing h2qp-wan-metric items to test exists() with")
