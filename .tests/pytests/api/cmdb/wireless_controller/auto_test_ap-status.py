...
class TestAutoApStatusGet:
    ...
    def auto_test_get_list_all(self):
        """Test GET - list all ap-status items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} ap-status items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific ap-status by id."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing ap-status items to test with")
        ...
        print(f"✅ Retrieved ap-status id={mkey_value}")
...
class TestAutoApStatusExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing ap-status items to test exists() with")
