...
class TestAutoPrefixList6Get:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all prefix-list6 items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} prefix-list6 items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific prefix-list6 by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing prefix-list6 items to test with")
        ...
        print(f"✅ Retrieved prefix-list6 name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoPrefixList6Exists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing prefix-list6 items to test exists() with")
...
class TestAutoPrefixList6Validators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_prefix_list6_create(config)
