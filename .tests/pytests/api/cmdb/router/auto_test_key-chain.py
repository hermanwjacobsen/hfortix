...
Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/router.key-chain.json
Category: cmdb
...
class TestAutoKeyChainValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_key_chain_create(config)
...
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/router.key-chain.json"
