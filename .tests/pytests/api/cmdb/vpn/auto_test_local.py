"""
Auto-generated basic tests for cmdb.vpn/certificate/local

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/vpn.certificate.local.json
Category: cmdb
...
endpoint = fgt.api.cmdb.vpn.certificate.local
...
class TestAutoLocalValidators:
    ...
    def auto_test_validator_import(self):
        ...
        try:
            from hfortix_fortios.api.v2.cmdb.vpn.certificate._helpers import local as validators
            print(f"✅ Successfully imported validators for local")
            
            # Check validator functions exist (they use HTTP method naming: post, put, get)
            assert hasattr(validators, "validate_vpn_certificate_local_post")
            assert hasattr(validators, "validate_vpn_certificate_local_put")
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_local_create(config)
...
TEST_ENDPOINT = "cmdb/vpn/certificate/local"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/vpn.certificate.local.json"
