...
Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/vpn.certificate.hsm-local.json
Category: cmdb
...
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/vpn.certificate.hsm-local.json"
