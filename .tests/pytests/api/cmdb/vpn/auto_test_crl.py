"""
Auto-generated basic tests for cmdb.vpn/certificate/crl

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/vpn.certificate.crl.json
Category: cmdb
...
endpoint = fgt.api.cmdb.vpn.certificate.crl


@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoCrlGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all crl items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} crl items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific crl by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing crl items to test with")
        ...
        print(f"✅ Retrieved crl name={mkey_value}")
...
class TestAutoCrlExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing crl items to test exists() with")
...
class TestAutoCrlValidators:
    ...
    def auto_test_validator_import(self):
        ...
        try:
            from hfortix_fortios.api.v2.cmdb.vpn.certificate._helpers import crl as validators
            print(f"✅ Successfully imported validators for crl")
            
            # Check validator functions exist (they use HTTP method naming: post, put, get)
            assert hasattr(validators, "validate_vpn_certificate_crl_post")
            assert hasattr(validators, "validate_vpn_certificate_crl_put")
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_crl_create(config)
...
TEST_ENDPOINT = "cmdb/vpn/certificate/crl"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/vpn.certificate.crl.json"
