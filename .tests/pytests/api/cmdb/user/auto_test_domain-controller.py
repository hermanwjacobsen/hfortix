...
class TestAutoDomainControllerGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all domain-controller items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} domain-controller items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific domain-controller by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing domain-controller items to test with")
        ...
        print(f"✅ Retrieved domain-controller name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoDomainControllerExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing domain-controller items to test exists() with")
...
class TestAutoDomainControllerValidators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_domain_controller_create(config)
