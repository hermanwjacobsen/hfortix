...
class TestAutoQuarantineGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - retrieve quarantine configuration."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved quarantine configuration (singleton)")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoQuarantineExists:
