...
class TestAutoWebPortalGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all web-portal items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} web-portal items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific web-portal by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing web-portal items to test with")
        ...
        print(f"✅ Retrieved web-portal name={mkey_value}")
...
class TestAutoWebPortalExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing web-portal items to test exists() with")
