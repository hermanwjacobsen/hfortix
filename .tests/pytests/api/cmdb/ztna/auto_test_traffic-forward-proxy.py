...
class TestAutoTrafficForwardProxyGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all traffic-forward-proxy items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} traffic-forward-proxy items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific traffic-forward-proxy by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing traffic-forward-proxy items to test with")
        ...
        print(f"✅ Retrieved traffic-forward-proxy name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoTrafficForwardProxyExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing traffic-forward-proxy items to test exists() with")
