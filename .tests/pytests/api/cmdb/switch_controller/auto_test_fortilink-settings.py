...
class TestAutoFortilinkSettingsGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all fortilink-settings items."""
        try:
        ...
        print(f"✅ Retrieved {len(result)} fortilink-settings items")
    ...
    def auto_test_get_specific_item(self):
        """Test GET - retrieve specific fortilink-settings by name."""
        ...
        if not all_items or len(all_items) == 0:
            pytest.skip("No existing fortilink-settings items to test with")
        ...
        print(f"✅ Retrieved fortilink-settings name={mkey_value}")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoFortilinkSettingsExists:
    ...
    def auto_test_exists_method(self):
        ...
        if all_items and len(all_items) > 0:
            ...
            pytest.skip("No existing fortilink-settings items to test exists() with")
