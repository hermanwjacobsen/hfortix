...
class TestAutoTrafficSnifferGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - retrieve traffic-sniffer configuration."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved traffic-sniffer configuration (singleton)")
...
@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoTrafficSnifferExists:
