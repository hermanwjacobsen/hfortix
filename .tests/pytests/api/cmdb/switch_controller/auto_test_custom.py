"""
Auto-generated basic tests for cmdb.switch_controller/auto_config/custom

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/switch-controller.auto-config.custom.json
Category: cmdb
Endpoint: /cmdb/switch-controller.auto-config/custom
...
endpoint = fgt.api.cmdb.switch_controller.auto_config.custom
...
class TestAutoCustomValidators:
    ...
    def auto_test_validator_import(self):
        ...
        try:
            from hfortix_fortios.api.v2.cmdb.switch_controller.auto_config._helpers import custom as validators
            print(f"✅ Successfully imported validators for custom")
            
            # Check validator functions exist (they use HTTP method naming: post, put, get)
            assert hasattr(validators, "validate_switch_controller_auto_config_custom_post")
            assert hasattr(validators, "validate_switch_controller_auto_config_custom_put")
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_custom_create(config)
...
TEST_ENDPOINT = "cmdb/switch_controller/auto_config/custom"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/switch-controller.auto-config.custom.json"
