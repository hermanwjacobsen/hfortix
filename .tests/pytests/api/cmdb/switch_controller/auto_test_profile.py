"""
Auto-generated basic tests for cmdb.switch_controller/ptp/profile

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/switch-controller.ptp.profile.json
Category: cmdb
Endpoint: /cmdb/switch-controller.ptp/profile
...
endpoint = fgt.api.cmdb.switch_controller.ptp.profile
...
class TestAutoProfileValidators:
    ...
    def auto_test_validator_import(self):
        ...
        try:
            from hfortix_fortios.api.v2.cmdb.switch_controller.ptp._helpers import profile as validators
            print(f"✅ Successfully imported validators for profile")
            
            # Check validator functions exist (they use HTTP method naming: post, put, get)
            assert hasattr(validators, "validate_switch_controller_ptp_profile_post")
            assert hasattr(validators, "validate_switch_controller_ptp_profile_put")
...
class TestAutoProfileEnums:
    ...
    def auto_test_enum_mode(self):
        ...
        valid_values = ['transparent-e2e', 'transparent-p2p']
    ...
    def auto_test_enum_ptp_profile(self):
        """Test enum field ptp-profile validation."""
        from hfortix_fortios.api.v2.cmdb.switch_controller.ptp._helpers import profile as validators
        
        valid_values = ['C37.238-2017']
        
        # Test each valid value
        for value in valid_values:
            config = {"ptp-profile": value}
            # Validators should accept any valid enum value
            # Note: Full validation requires all required fields
            print(f"   Valid enum value: ptp-profile={value}")
        
        print(f"✅ Enum field ptp-profile has {len(valid_values)} valid values")
    def auto_test_enum_transport(self):
        """Test enum field transport validation."""
        from hfortix_fortios.api.v2.cmdb.switch_controller.ptp._helpers import profile as validators
        
        valid_values = ['l2-mcast']
        ...
        for value in valid_values:
            ...
            # Validators should accept any valid enum value
            # Note: Full validation requires all required fields
            print(f"   Valid enum value: transport={value}")
        
        print(f"✅ Enum field transport has {len(valid_values)} valid values")




# Metadata for test discovery
TEST_ENDPOINT = "cmdb/switch_controller/ptp/profile"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/switch-controller.ptp.profile.json"
