"""
Auto-generated basic tests for cmdb.certificate/hsm_local

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/certificate.hsm-local.json
Category: cmdb
Endpoint: /cmdb/certificate/hsm-local
...
endpoint = fgt.api.cmdb.certificate.hsm_local
...
class TestAutoHsmLocalValidators:
    ...
    def auto_test_validator_import(self):
        ...
        try:
            from hfortix_fortios.api.v2.cmdb.certificate._helpers import hsm_local as validators
            print(f"✅ Successfully imported validators for hsm-local")
            
            # Check validator functions exist (they use HTTP method naming: post, put, get)
            assert hasattr(validators, "validate_certificate_hsm_local_post")
            assert hasattr(validators, "validate_certificate_hsm_local_put")
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_hsm_local_create(config)
...
TEST_ENDPOINT = "cmdb/certificate/hsm_local"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/certificate.hsm-local.json"
