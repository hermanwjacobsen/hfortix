"""
Auto-generated basic tests for cmdb.rule/fmwp

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/rule.fmwp.json
Category: cmdb
Endpoint: /cmdb/rule/fmwp

These are BASIC automated tests. For comprehensive testing, create
manual tests in test_fmwp.py
...
endpoint = fgt.api.cmdb.rule.fmwp


@pytest.mark.api_call
@pytest.mark.read_only
class TestAutoFmwpGet:
    """Auto-generated GET operation tests."""
    
    def auto_test_get_list_all(self):
        """Test GET - list all fmwp items."""
        try:
            result = endpoint.get()
        ...
        print(f"✅ Retrieved {len(result)} fmwp items")
...
class TestAutoFmwpEnums:
    """Auto-generated enum validation tests."""
    
    def auto_test_enum_status(self):
        """Test enum field status validation."""
        from hfortix_fortios.api.v2.cmdb.rule._helpers import fmwp as validators
...
TEST_ENDPOINT = "cmdb/rule/fmwp"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/rule.fmwp.json"
