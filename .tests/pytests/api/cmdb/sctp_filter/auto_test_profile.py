"""
Auto-generated basic tests for cmdb.sctp_filter/profile

Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/cmdb/sctp-filter.profile.json
Category: cmdb
Endpoint: /cmdb/sctp-filter/profile
...
endpoint = fgt.api.cmdb.sctp_filter.profile
...
class TestAutoProfileValidators:
    ...
    def auto_test_validator_import(self):
        ...
        try:
            from hfortix_fortios.api.v2.cmdb.sctp_filter._helpers import profile as validators
            print(f"✅ Successfully imported validators for profile")
            
            # Check validator functions exist (they use HTTP method naming: post, put, get)
            assert hasattr(validators, "validate_sctp_filter_profile_post")
            assert hasattr(validators, "validate_sctp_filter_profile_put")
...
TEST_ENDPOINT = "cmdb/sctp_filter/profile"
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/cmdb/sctp-filter.profile.json"
