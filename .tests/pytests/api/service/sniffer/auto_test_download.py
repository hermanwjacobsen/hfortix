...
Generated from schema: /app/dev/classes/fortinet/schema/7.6.5/service/sniffer.download.json
Category: service
...
TEST_SCHEMA = "/app/dev/classes/fortinet/schema/7.6.5/service/sniffer.download.json"
